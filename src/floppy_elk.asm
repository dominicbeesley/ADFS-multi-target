...
; ----------------------------------------------------------------------------
elkLBA38:	lda     FDC_CMD                           ; BA38 AD C4 FC                 ...
		ror     a                               ; BA3B 6A                       j
...
; ----------------------------------------------------------------------------
LBA61:		lda	TUBEIO                           ; BA61 AD E5 FC                 ...
		tax                                     ; BA64 AA                       .
		jmp	elkLBA38                           ; BA65 4C 38 BA                 L8.

; ----------------------------------------------------------------------------
LBA68:		sta	TUBEIO                           ; BA68 8D E5 FC                 ...
		jmp	elkLBA52                           ; BA6B 4C 52 BA                 LR.

; ----------------------------------------------------------------------------
LBA6E:		sta	($CE),y                         ; BA6E 91 CE                    ..
		iny                                     ; BA70 C8                       .
		jmp     elkLBA52                           ; BA71 4C 52 BA                 LR.

; ----------------------------------------------------------------------------
LBA74:		lda     ($CE),y                         ; BA74 B1 CE                    ..
		tax                                     ; BA76 AA                       .
...
elkLBAC7:	bit     $CD                             ; BAC7 24 CD                    $.
		...
		ldx     #<LBA61                         ; BAE6 A2 61                    .a
		ldy     #>LBA61                         ; BAE8 A0 BA                    ..
		jmp     elkLBB03                           ; BAEA 4C 03 BB                 L..

; ----------------------------------------------------------------------------
elkLBAED:	ldx     #<LBA68                         ; BAED A2 68                    .h
		ldy     #>LBA68                         ; BAEF A0 BA                    ..
		jmp     elkLBB03                           ; BAF1 4C 03 BB                 L..

; ----------------------------------------------------------------------------
elkLBAF4:  	bit     $A1                             ; BAF4 24 A1                    $.
		bmi   	elkLBAFF                           ; BAF6 30 07                    0.
		ldx     #<LBA74                            ; BAF8 A2 74                    .t
		ldy     #>LBA74                            ; BAFA A0 BA                    ..
		jmp     elkLBB03                           ; BAFC 4C 03 BB                 L..

; ----------------------------------------------------------------------------
elkLBAFF:	ldx     #<LBA6E                         ; BAFF A2 6E                    .n
		ldy     #>LBA6E                         ; BB01 A0 BA                    ..
